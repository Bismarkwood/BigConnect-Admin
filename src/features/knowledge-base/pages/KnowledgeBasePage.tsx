    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">Manage training data and documents</p>
        </div>
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-12 text-center">
        ...
        <p className="mt-4 text-sm font-medium text-slate-600">Knowledge Base module coming soon</p>
        <p className="mt-1 text-xs text-slate-400">Upload and manage training documents for AI agents</p>
      </div>
    </div>
  )
}
