...
function AIAgentsTab({ clientId: _clientId }: AIAgentsTabProps) {
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-5 gap-3">
        <SummaryCard label="Total Agents" value={String(mockAgents.length)} icon={<Bot className="h-4 w-4 text-violet-600" strokeWidth={1.5} />} />
        <SummaryCard label="Live" value={String(liveAgents)} icon={<CheckCircle2 className="h-4 w-4 text-emerald-600" strokeWidth={1.5} />} />
        <SummaryCard label="Testing" value={String(testingAgents)} icon={<AlertCircle className="h-4 w-4 text-blue-600" strokeWidth={1.5} />} />
        <SummaryCard label="Conversations" value={totalConversations.toLocaleString()} icon={<MessageSquare className="h-4 w-4 text-amber-600" strokeWidth={1.5} />} />
        <SummaryCard label="Avg Resolution" value="84%" icon={<BarChart3 className="h-4 w-4 text-blue-600" strokeWidth={1.5} />} />
      </div>
